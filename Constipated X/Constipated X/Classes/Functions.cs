...
namespace Constipated_X
{
    class Functions
    {
        public static string exploitdllname = "CryonAPI.dll";//Axon.dll this is the name of your dll
        public static void Inject()
        {
            ...
            else if (!NamedPipes.NamedPipeExist(NamedPipes.luapipename))//check if the pipe don't exist
            {
                ...
                {
                    MessageBox.Show("Unable to create Pipe \n please make sure the exploit is up to date \n it upates every friday, and it out of date on thursday.", "Error!", MessageBoxButtons.OK, MessageBoxIcon.Error);//display that the pipe was not found so the injection was unsuccessful
                }
            }
        }
        ...
        public static OpenFileDialog openfiledialog = new OpenFileDialog
        {
            ...
            Title = "Constipate Open Script"//OpenFileDialog Tittle
